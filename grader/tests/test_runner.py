...
class TestRunner(TestCase):
    ...
    def test_run_command_exec_memory(self):
        run_result = Runner.run_command(sandbox=Sandbox(), command="factor {}".format("1234567890" * 4), timeout=1.0)
        self.assertTrue(2**20 <= run_result.exec_memory <= 2**23)  # Between 1 and 8 megabytes

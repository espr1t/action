    ...
    public function getContent() {
        $version = '
            <div class="help-version">
                Версия на системата: <a href="https://github.com/espr1t/action/commit/150c485cc23369a485602119234852003048ba39" target="_blank">v.171003.150c485</a>
            </div>
        ';
        ...
        ') . $version
           . inBox('
            ...
            В менюто отдолу има линк "report a bug", чрез който регистрираните потребители могат да се свържат с админ
            и да съобщят за проблем (било то със системата или с някоя от задачите). Не се притеснявайте да го ползвате
            дори за малки проблеми като правописни грешки.
        ') . inBox('

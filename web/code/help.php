    ...
    public function getContent() {
        $version = '
            <div class="help-version">
                Версия на системата: <a href="https://github.com/espr1t/action/commit/1cb24703027bb01e7d36939d3653274b206081f7" target="_blank">v.171224.1cb2470</a>
            </div>
        ';
        ...
        ') . $version
           . inBox('
            ...
            В менюто отдолу има линк "съобщи за проблем", чрез който регистрираните потребители могат да се свържат с
            админ и да съобщят за проблем (било то със системата или с някоя от задачите). Не се притеснявайте да го
            ползвате дори за малки проблеми като правописни грешки.
        ') . inBox('
        ...
        ') . inBox('
            ...
            <ul>
                ...
                препоръчително да известите админ чрез линка "съобщи за проблем" в менюто най-долу.</li>
            ...
            Заедно със статус кода ще получите и допълнителна информация - например на кой тест се е получена грешка или
            колко точки сте получили на всеки от тестовете. Информацията за всеки от Вашите събмити се пази на системата
            и може да бъде достъпена (само от вас) по всяко време през линка "Предишни решения" под условието на всяка
            задача.
        ') . inBox('
            ...
            Това сравнение е такова, че да работи както за много малки, така и за много големи числа.
            <br><br>
        ...
        ') . inBox('
            ...
            решена задача и много други (близо сто). Някои от тях са логични и очаквани (например завършването на дадена
            тема от подготовката), докато други са по-нестандартни и се присъждат на значително по-малък брой
            потребители. =)
        ') . inBox('
            ...
            профила на всеки от тях). Класирането по подразбиране се прави на базата на точки, които потребителите
            събират решавайки задачи (по-трудни задачи носят повече точки), както и от постижения.
            <br><br>
            Системата предоставя възможност класирането да бъде подредено и по брой решени задачи или пък брой
            постижения.
        ') . inBox('

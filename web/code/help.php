    ...
    public function getContent() {
        ...
        ') . inBox('
            ...
            <ul>
                ...
                <li><b>Memory Limit:</b> Решението използва повече памет, от допустимата за задачата.</li>
            ...
            Заедно със статус кода ще получите и допълнителна информация - например на кой тест се е случила грешката или колко точки сте получили на всеки от тестовете.
            Информацията за всеки от Вашите събмити се пази на системата и може да бъде достъпен (вамо от вас) по всяко време през линка "Предишни опити" под условието на всяка задача.
        ') . inBox('

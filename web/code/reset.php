...
class ResetPage extends Page {
    ...
    private function sendResetEmail() {
        ...
        $address = $user->email;
        $subject = "Password reset for user " . $user->username;
        $content = "<html><body>" .
                   "<larger>Здравейте, <strong>" . $user->username . "</strong>!</larger><br><br>" .
                   "Поискана е смяна на паролата за Вашия потребител на сайта action.informatika.bg.<br>" .
                   ...
                   "този e-mail и се извиняваме за безпокойствието.<br><br>" .
                   "Поздрави,<br>" .
    ...
    private function emailSentPage() {
        return inBox('
    ...
    private function getResetForm($username) {
        $content = '

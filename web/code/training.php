...
class TrainingPage extends Page {
    ...
    private function initADDP($position) {
        ...
        $expanded = '
            ...
            <a href="http://www.informatika.bg/lectures/long-numbers" target="_blank">дълги числа</a>).
        ';
        $problems = '231,152,159,23,17,31,44,103';
        $brain->addTopic($position, $key, $link, $title, $summary, $expanded, $problems);
    }
    ...
    private function initVARI($position) {
        ...
        $expanded = '
            ...
            <br><br>
            <a href="/problems/53">Tetris</a> и <a href="/problems/86">Bubbles</a> са оптимизационни задачи и изискват
            неперфектно решение (в случая подходът
            <a href="https://en.wikipedia.org/wiki/Beam_search" target="_blank">Beam Search</a> върши чудесна работа).
            <br><br>
